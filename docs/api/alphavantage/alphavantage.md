...
| [crypto](#)          | Access to Digital Currencies. Returns a Crypto Instance for access to Digital Currency data. `public Crypto crypto()`               |
| [exchangeRate](#)    | Access to Exchange Rates Data. `public ExchangeRate exhcangeRate()`                                                                 |
