 ...
 * a rolling time period with no chosen price series — {@code WILLR},
 * {@code ADX}, {@code ADXR}, {@code CCI}, {@code AROONOSC}, {@code MFI},
 * {@code DX}, {@code MINUS_DI}, {@code PLUS_DI}, {@code MINUS_DM},
 * {@code PLUS_DM}, {@code MIDPRICE}, {@code ATR}, and {@code NATR}.
 *
 * @author Sylvester Sefa-Yeboah
 * @since 1.1.0
 * @deprecated Replaced by {@link com.crazzyghost.alphavantage.technicalindicator.response.PeriodicResponse}
 */
@Deprecated
public abstract class PeriodicResponse {
    ...
    /**
     * Base parser for {@link PeriodicResponse} subclasses, translating the
     * raw metadata and indicator maps returned by {@link
     * com.crazzyghost.alphavantage.parser.Parser} into typed {@link MetaData}
     * and {@link SimpleIndicatorUnit} values.
     *
     ...
     * PeriodicResponse}, echoed back by the API alongside the indicator
     * values themselves.
     */
