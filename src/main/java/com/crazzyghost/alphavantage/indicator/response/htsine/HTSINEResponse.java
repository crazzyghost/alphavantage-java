 ...
 * the single-value {@code SimpleIndicatorUnit} the shared bases
 * use.
 *
 * @author Sylvester Sefa-Yeboah
 * @since 1.1.0
 * @deprecated Replaced by {@link com.crazzyghost.alphavantage.technicalindicator.response.htsine.HTSINEResponse}
 */
@Deprecated
public class HTSINEResponse {
    ...
    /** The indicator's Sine/Lead Sine readings, one unit per date in the requested series. */
    ...
    /**
     * Parses a raw API response into an {@link HTSINEResponse}.
     *
