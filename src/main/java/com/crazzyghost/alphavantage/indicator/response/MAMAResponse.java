...
public class MAMAResponse {
    ...
    public void setForexUnits(List<MAMAIndicatorUnit> indicatorUnits) {
        this.indicatorUnits = indicatorUnits;
    }
    ...
    public static class MetaData {
        ...
        public MetaData(String symbol, String indicator, String lastRefreshed, String interval, double fastLimit,
                double slowLimit, String timeZone, String seriesType) {
            this.symbol = symbol;
